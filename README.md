...
APK Android signe: [Cisco-CLI-Lexique-Android-v1.1.7.apk](downloads/Cisco-CLI-Lexique-Android-v1.1.7.apk)
...
- Filtres principaux par navigation interne fiable, sans reconstruction bloquante apres le clic.
- Chargement limite a 8 fiches par lot dans les categories filtrees pour preserver la reactivite des menus.
- Sous-menus de themes toujours actifs: choisir un theme libere automatiquement le filtre de categorie precedent.
